<template>
    <Dialog :visible="visible" @update:visible="updateVisible" class="upload-modal-dialog" modal dismissableMask @hide="closeModal" :style="{ maxWidth: '80vw', maxHeight: '80vh' }">
                ...
                <div class="form">
                    ...
                    <form v-if="imageSrc" @submit.prevent="submitForm">
                        <div class="icon-container">
                            ...
                            <div v-else class="loader small-loader"></div>
        ...
        const submitForm = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    emit('image-uploaded');  // Add this line
                    router.push('/');
                } else {
